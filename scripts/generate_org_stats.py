...
def build_svg(payload: dict[str, object]) -> str:
  ...
  <text x="92" y="376" fill="#667a9e" font-size="14" font-family="Segoe UI, Arial, sans-serif">
    live organization footprint
  </text>
  <text x="92" y="396" fill="#667a9e" font-size="14" font-family="Segoe UI, Arial, sans-serif">
    from the current GitHub API snapshot
  </text>

  <rect x="88" y="428" width="152" height="92" rx="18" fill="#0d2242" />
  <text x="110" y="462" fill="#8fa6cb" font-size="12" font-family="Segoe UI, Arial, sans-serif" font-weight="700" letter-spacing="1.1">
    PUBLIC
  </text>
  <text x="110" y="504" fill="#55d6ff" font-size="36" font-family="Segoe UI, Arial, sans-serif" font-weight="700">
    {public_count}
  </text>

  <rect x="254" y="428" width="152" height="92" rx="18" fill="#0d2242" />
  <text x="276" y="462" fill="#8fa6cb" font-size="12" font-family="Segoe UI, Arial, sans-serif" font-weight="700" letter-spacing="1.1">
    PRIVATE
  </text>
  <text x="276" y="504" fill="#ff4f8b" font-size="36" font-family="Segoe UI, Arial, sans-serif" font-weight="700">
    {private_count}
  </text>

  <text x="88" y="554" fill="#8fa6cb" font-size="12" font-family="Segoe UI, Arial, sans-serif" font-weight="700" letter-spacing="1.1">
    VISIBILITY SPLIT
  </text>
  <rect x="88" y="568" width="336" height="16" rx="8" fill="#142340" />
  <rect x="88" y="568" width="{public_width:.2f}" height="16" rx="8" fill="url(#publicBar)" />
  <rect x="{88 + public_width:.2f}" y="568" width="{private_width:.2f}" height="16" rx="8" fill="#ff4f8b" />

  <text x="88" y="610" fill="#55d6ff" font-size="13" font-family="Segoe UI, Arial, sans-serif" font-weight="700">
    public
  </text>
  <text x="370" y="610" fill="#ff4f8b" font-size="13" font-family="Segoe UI, Arial, sans-serif" font-weight="700" text-anchor="end">
    private
  </text>
